<?php
echo <<<_MODAL
  <div class="modal confirmComplete" id="modal_confirm_complete" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>1. The entire document will be sent to the proofreading team.</p>
          ...
          <p> Make sure you transcribed all the document pages.</p>
          <br />
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" id="btnCompleteConfirm">Confirm</button>
        </div>
      </div>
    </div>
    </div>
