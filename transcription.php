      ...
      <div class="row align-items-center">
        ...
        <div class="col-4 text-end p-0" id="toolbarDiv">
          <div class="btn-group" role="group" aria-label="Basic example">
            <button title="Previous page" type="button" class="btn btn-primary" id="btnPrev"> <i class="material-icons">chevron_left</i> </button>
            <?php echo $btnHome; ?>
            </button>
            <button title="Next Page" type="button" class="btn btn-primary" id="btnNext"> <i class="material-icons">chevron_right</i> </button>
          </div>
          <div class="btn-group" role="group" aria-label="Basic example">
